$(function() {
	...
	$(window).on('load', function(e) {
		$('.stack-container-1 .stack').addClass('animated');
	});

	$('.stack-slider', '.stack').slick({
		slidesToShow: 1,
		slidesToScroll: 1,
		arrows: false,
		dots: false,
	...
	function scrollEffects() {
		if(Utils.isElementInView($('.photos'), true)) {
			$('.photos').addClass('animated');
		}

		if(Utils.isElementInView($('.stack-container-2'), true)) {
			$('.stack-container-2 .stack').addClass('animated');
		}

		if(Utils.isElementInView($('.stack-container-3'), true)) {
			$('.stack-container-3 .stack').addClass('animated');
		}
	}
